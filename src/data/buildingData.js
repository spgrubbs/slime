...
export const BUILDINGS = {
  ...
  spawningVat: {
    ...
    cost: { biomass: 200, mats: { 'Wolf Pelt': 5, 'Bat Wing': 5 } },
    max: 1,
    category: 'tier',
  },
  royalHatchery: {
    ...
    cost: { biomass: 800, mats: { 'Turtle Shell': 3, 'Mana Crystal': 5 } },
    max: 1,
    category: 'tier',
  },
  primordialChamber: {
    ...
    cost: { biomass: 3000, mats: { 'Dragon Scale': 2, 'Dark Essence': 5, 'Golem Core': 3 } },
    max: 1,
    category: 'tier',
  },
  ...
  defenseSlot: {
    ...
    cost: { biomass: 500, mats: { 'Bone Dust': 5, 'Ancient Stone': 3 } },
  ...
  researchLab: {
    ...
    cost: { biomass: 400, mats: { 'Mana Crystal': 3, 'Ancient Stone': 5 } },
    max: 1,
    category: 'utility',
  },
