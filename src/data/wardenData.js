...
export const WARDENS = {
  forest: {
    ...
    ability: 'cleave',
    mechanic: 'thornskin',
    abilities: ['Thornskin — returns a share of every hit', 'Sweeping limbs'],
    counter: 'Vinewebs blocks outright, and Sharp means fewer, harder hits to be torn on.',
    seal: 'Heartwood Seal',
  ...
  swamp: {
    ...
    ability: 'venomBite',
    mechanic: 'fenRot',
    abilities: ['Fen Rot — knits itself back each round', 'Drowning grasp'],
    counter: 'An open wound will not close — Spiny keeps it bleeding. Later, anything that burns stops all healing.',
    seal: 'Bog Seal',
    heart: 'Mire Core',
  },
  caves: {
    ...
    ability: 'rockThrow',
    mechanic: 'refraction',
    abilities: ['Refraction — critical hits are turned back', 'Crystalline hide'],
    counter: 'Leave the crit build at home. Firmness and health beat it; Sharp is a liability.',
    seal: 'Geode Seal',
    heart: 'Geode Core',
  },
  ruins: {
    ...
    abilities: ['Everburning — hits harder every round it stands', 'Slag wave'],
    counter: 'A stun scatters the heat. Ghastly Wail is the vent; Earthshaker works too.',
    seal: 'Cinder Seal',
    heart: 'Cinder Core',
  },
  peaks: {
    ...
    ability: 'frostBreath',
    mechanic: 'stormlash',
    abilities: ['Stormlash — cannot be blocked or phased, only dodged', 'Thunderclap'],
    counter: 'Interception is worthless. Bring slipperiness, and Permafrost to blunt what lands.',
    seal: 'Storm Seal',
  ...
  volcano: {
    ...
    ability: 'voidTouch',
    mechanic: 'nullField',
    abilities: ['Null Field — hardens against every element that hits it', 'Unmaking'],
    counter: 'It learns whatever keeps hitting it. Four different affinities take four times as long to teach.',
    seal: 'Void Seal',
